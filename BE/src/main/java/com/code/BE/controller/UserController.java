...
public class UserController {
    ...
    public ResponseEntity<ApiResponse<UserResponse>> returnUserByUsername(@PathVariable String username) throws Exception {
        try {
    ...
    @DeleteMapping("/{id}")
    public ResponseEntity<ApiResponse<String>> deleteEvent(@PathVariable int id) throws Exception {
