...
const StaffDashboard = () => {
    ...
    const loadData = () => {
        fetchData(
            ...
            fetchData(
                `http://localhost:8080/api/v1/staff-dashboard/staff-dashboard-daily?stallId=${data.payload.stallId}&date=${getCurrentDateFormatted()}`,
                "GET",
                null,
                userInfo.accessToken
            ).then((data) => {
    ...
    return (
        <CRow>
            <CCol xs="12">
                <CCard>
                    <CCardHeader>Staff Dashboard - {data.date}</CCardHeader>
                    <CCardBody>
                        <CRow className="mb-4">
            ...
            <CModal visible={modal} onClose={handleExit}>
                ...
                <CModalBody>Are you sure you want to confirm this action?</CModalBody>
                <CModalFooter>
